...
export const codeCompile = async (language, code, input) => {
    const URL = "https://codelab-server-coral.vercel.app/api/compile";//change after 6 7
    const options = {
        method: "POST",
        headers: {
...
export const fetchCodes = async(user)=>{
    ...
    const url = 'https://codelab-server-coral.vercel.app/api/codes';
    const options = {
        method: 'GET',
        headers: {
...
export const updateCode = async (user, id, title, code, language, input) => {
    const url = `https://codelab-server-coral.vercel.app/api/codes/${id}`;
    const options = {
        method: 'PUT',
        headers:{
            'authorization': `Bearer ${user.token}`,
...
export const basicLogin = async (data) => {
    const url = 'https://codelab-server-coral.vercel.app/api/basicauth/login';
    const options = {
        method: 'POST',
        headers: {
            'content-type': 'application/json'
...
export const basicSignup = async (data) => {
    const url = 'https://codelab-server-coral.vercel.app/api/basicauth/signup';
    const options = {
        method: 'POST',
        headers: {
            'content-type': 'application/json'
